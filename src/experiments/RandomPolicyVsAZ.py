    ...
    for i in range(SIMULATIONS):
        ...
        if i % 2 == 0:
            ...
            if winner == 0:
                ...
                game_stats = [i, "AZPolicy", game.turns, sum_reserve(game.game_state.reserves[1]),
                              sum_reserve(game.game_state.reserves[0])]
            else:
                game_stats = [i, "Draw", game.turns, sum_reserve(game.game_state.reserves[1]), sum_reserve(game.game_state.reserves[0])]
