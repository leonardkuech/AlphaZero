...
def main():
    ...
    for i in range(len(models)):
        ...
        for j in range(500):
            ...
            if j % 2 == 0:
                ...
                game = Game.create_agent_game(az_agent, random_agent)
                game.init()
                game.start()
                ...
                game = Game.create_agent_game(random_agent, az_agent)
    ...
    winrate_AZVRandom.to_csv("../data/AZVsRandomWinrate.csv", index=False)
